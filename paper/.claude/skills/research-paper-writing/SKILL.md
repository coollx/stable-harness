...
- The worked-example bank is drawn from 3D vision and generative modeling; reuse the sentence logic, never the domain vocabulary, and prefer examples from the paper's own reference corpus.
- Where this skill's guidance disagrees with `paper/style/style-guide.md`, the style guide wins.
